import { detectSections } from "../utils/sectionHelpers";
...
export const calculateSectionScore = (resumeText) => {
  ...
  if (totalExpected === 0) return { score: 0, found: [], missing: [], suggestions: [] };
  ...
  if (missingSections.includes("Experience")) {
    suggestions.push("Missing 'Experience' section. This is critical for ATS parsing.");
  ...
  if (missingSections.includes("Skills")) {
    suggestions.push("A dedicated 'Skills' section is missing. ATS systems scan this heavily.");
  }
